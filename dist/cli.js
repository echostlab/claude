...
// src/package/cli.ts
var PACKAGE_VERSION = "0.0.0-source";
function getRepoRoot() {
  const distDir = dirname(fileURLToPath(import.meta.url));
  return resolve(distDir, "..");
}
function getRequiredMirrorPaths(repoRoot) {
  return [
    "README.md",
    "package.json",
...
function assertMirrorLayout(repoRoot) {
...
program2.name("claude").description("Buildable CLI wrapper for the Claude Code source mirror package.").version(PACKAGE_VERSION);
program2.command("check").description("Verify that the packaged source mirror layout is present.").action(() => {
